...
export const FILTER_BY_BRAND_CERVEZA = "FILTER_BY_BRAND_CERVEZA"; //por marcas
export const FILTER_BY_BRAND_VINO = "FILTER_BY_BRAND_VINO"; //por marcas
export const FILTER_BY_BRAND_ESPUMANTE = "FILTER_BY_BRAND_ESPUMANTE"; //por marcas
export const FILTER_BY_BRAND_DESTILADO = "FILTER_BY_BRAND_DESTILADO"; //por marcas
